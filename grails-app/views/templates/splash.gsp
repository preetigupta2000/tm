<sec:ifLoggedIn>
	<script>
		com.fonantrix.application.tm.userinfo.loggedin = true;
	</script>
</sec:ifLoggedIn>
	<div class="row">
		<div class="col-md-6 hidden-xs">
			...
			<div class="tm-info">
				<h4>Focus on the present, <small>Ordinary people think merely of spending time. Great people think of using it.</small></h4>
		...
		<div class="col-md-offset-1 col-md-5" id="login-info">
