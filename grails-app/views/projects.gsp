					...
					<div class="col-md-12">				
						<div class="headerband">				
							...
							<span class="pull-right">
								...
								<button id="addNewUser" class="btn btn-default btn-sm navigationbutton" data-toggle="modal" href="#addProjectModal"><i class="fa fa-plus"></i>  Add New Project</button>
							</span>
						</div>
					</div>
				</div>
				...
				<div class="modal-body">
					...
					<div class="form-group">
			          ...
			          <div class="controls">
			          	...
			          	<g:else>
			          		<g:textField disabled id="id-display" name="id-display" class="input-lg" value="${clientid}"></g:textField>
			          	</g:else>
			          </div>
			        </div>	
			   </div>
